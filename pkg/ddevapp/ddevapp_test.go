...
var (
	TestSites = []testcommon.TestSite{
		...
		},
		{
			...
			SourceURL:                     "https://ftp.drupal.org/files/projects/drupal-8.4.4.tar.gz",
		...
		{
			Name:                          "TestMainPkgDrupal6",
			SourceURL:                     "https://ftp.drupal.org/files/projects/drupal-6.38.tar.gz",
			ArchiveInternalExtractionPath: "drupal-6.38/",
			FilesTarballURL:               "https://github.com/drud/drupal6_test/releases/download/v0.1.0/files.tar.gz",
			FilesZipballURL:               "https://github.com/drud/drupal6_test/releases/download/v0.1.0/files.zip",
			DBTarURL:                      "https://github.com/drud/drupal6_test/releases/download/v0.1.0/db.tar.gz",
			DBZipURL:                      "https://github.com/drud/drupal6_test/releases/download/v0.1.0/db.zip",
			FullSiteTarballURL:            "https://github.com/drud/drupal6_test/releases/download/v0.1.0/site.tar.gz",
			Type:                          "drupal6",
		},
		{
			Name:                          "TestMainPkgTypo3",
			SourceURL:                     "https://get.typo3.org/8.7.9",
			ArchiveInternalExtractionPath: "typo3_src-8.7.9/",
			FilesTarballURL:               "https://github.com/drud/typo3_test/releases/download/v0.1.0/files.tar.gz",
			FilesZipballURL:               "https://github.com/drud/typo3_test/releases/download/v0.1.0/files.zip",
			DBTarURL:                      "https://github.com/drud/typo3_test/releases/download/v0.1.0/db.tar.gz",
			DBZipURL:                      "https://github.com/drud/typo3_test/releases/download/v0.1.0/db.zip",
			FullSiteTarballURL:            "https://github.com/drud/typo3_test/releases/download/v0.1.0/site.tar.gz",
			Type:                          "typo3",
		},
		{
