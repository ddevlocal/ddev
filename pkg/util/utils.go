...
// This is required for docker bind mounts on WIndows
// Sadly, if we have a Windows drive name, it has to be converted from C:\ to /c for Docker
// and //c for Docker Toolbox
